                          ...
                          <div className="cardtextsection">
                            ...
                            <div className="bedsbaths">
                              <span className="biid1">
                                ...
                                {data.property_bedroom}{" "}
                                {data.property_bedroom == 1
                                  ? "bedroom"
                                  : "beds"}{" "}
                              </span>
                              <span>
                                <img src={baths} className="baths" />{" "}
                                {data.property_bathroom}{" "}
                                {data.property_bathroom == 1
                                  ? "baths"
                                  : "baths"}{" "}
                              </span>
                            </div>
      ...
      >
        ...
        <div className="containffe">
          <div className="slidewrapplarge descro1">
            ...
            >
              {/* {data1?.property_photo?.map((data, i) => ( */}
            ...
            <div className="housee1a">
              <div className="housee11">
                ...
                <div className="aamt">
                  {" "}
                  ₦ {FormatAmount(data1?.price)}
                </div>
              </div>

              <div className="flxc">
                <div className="biid1">
                  <img src={beds} className="baths" /> {data1.property_bedroom}{" "}
                  {data1.property_bedroom == 1 ? "bedroom" : "beds"}{" "}
                </div>
                <div>
                  <img src={baths} className="baths" />{" "}
                  {data1.property_bathroom}{" "}
                  {data1.property_bathroom == 1 ? "baths" : "baths"}{" "}
                </div>
