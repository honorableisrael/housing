...
const MortgageApplication_SecondStep = (props) => {
  ...
  React.useEffect(() => {
    ...
    if (urlkey == "userprofile" ? true : false) {
      notify("Some fields cannot be changed after applying for mortgage");
    }
    axios
      .all([
  ...
  const validateForm = () => {
    ...
    window.scrollTo(-0, -0);
    if (employer_phone?.length < 11 || employer_phone?.length > 11) {
      return setState({
        ...state,
                  ...
                  <Col md={6} className="eachfield">
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        className={
                          formError && !employer_phone ? "fmc formerror" : "fmc"
                        }
                        name="employer_phone"
                        placeholder=""
                      />
                  ...
                  <Col md={4} className="eachfield">
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        value={parseInt(year_to_retirement)}
                  ...
                  <Col md={4} className="eachfield2">
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        placeholder=""
                      >
                        <option>{employment_is_confirmed}</option>
