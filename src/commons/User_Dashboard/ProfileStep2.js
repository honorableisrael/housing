...
const Profile_2 = (props) => {
        ...
        axios.spread((res, res2, res3) => {
          ...
          if (res.status === 200) {
            setState({
              ...
              ...res3.data.data,
              hide: urlkey == "employment_info" ? true : false,
            });
          }
          if (res.status == 400) {
  ...
  const onchange = (e) => {
    ...
    if (
      (has_profile == 1 && e.target.name == "employment_state") ||
      e.target.name == "employment_present_position" ||
      e.target.name == "employer_address"
    ) {
      setState({
        ...state,
        [e.target.name]: e.target.value,
    ...
    <div>
      <Container fluid>
        <Row className="sdnnavrow">
          ...
          {!hide ? <SideBarProfile profile={true} /> : <UserdashboardSideBar />}
                ...
                <Row className="poll878">
                  ...
                  <Col md={6} className="eachfield2">
                    <Form.Group>
                      <span
                        className={
                          formError && !bvn ? "userprofile" : "userprofile"
                        }
                      >
                        BVN
                      </span>
